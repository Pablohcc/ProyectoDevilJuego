...
public class OtraPruebaBala : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		if (debeAplicarFuerza)
		{
			...
			// Desactiva el flag para que solo ocurra una vez

			debeAplicarFuerza = false;
			Debug.Log("Fuerza aplicada en FixedUpdate");
		}

	}

	public void DispararAlJugador2()
	{
		if (jugador == null) return;
	...
	public void ActivarEventoFisico2()
	{
